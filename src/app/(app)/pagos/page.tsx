  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link href="/cuotas" className={buttonVariants({ size: "sm", className: "w-fit" })}>
      ...
      {pago === "registrado" && (
        <p className="rounded-md border border-success/30 bg-success-soft px-4 py-2 text-sm text-success">
