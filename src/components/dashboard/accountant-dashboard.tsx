import { DollarSign, ClipboardList, CheckCircle2, XCircle, LineChart, ShieldCheck } from "lucide-react";
...
export function AccountantDashboard({
  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      ...
      <QuickActions
        actions={[
          { href: "/inversiones?status=PENDING_VALIDATION", label: "Validar pendientes", icon: ShieldCheck },
